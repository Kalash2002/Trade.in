...
const LandingNavbar = () => {
  return (
    <div className="fixed flex flex-row w-full items-center justify-between bg-[#111827] text-white opacity-90 z-[1]">
      ...
      {/* Deskop view navbar */}
      <div>
        <div className=" hidden w-full md:flex md:flex-row md:justify-normal justify-center items-center">
          <SearchBar />
